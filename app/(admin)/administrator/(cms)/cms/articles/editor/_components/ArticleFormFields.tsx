  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      <div className="md:col-span-2">
        ...
        className='text-xs w-full px-3 py-2.5 border rounded focus:outline-none focus:ring-3 duration-300 border-gray-300 focus:border-primary focus:ring-primary/50
         disabled:opacity-50 disabled:bg-gray-100 placeholder:text-gray-400'
        />
        </div>
    </div>
