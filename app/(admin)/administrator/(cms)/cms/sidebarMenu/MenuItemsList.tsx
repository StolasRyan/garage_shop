  ...
  return (
    <div className="space-y-4  flex-1">
      {items.map((item, index)=>(
        ...
        className={`group w-full flex items-center gap-3 px-3 py-2 rounded-2xl text-left cursor-pointer transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.99] ${item.shadow} animate-slideIn`}
        style={{
