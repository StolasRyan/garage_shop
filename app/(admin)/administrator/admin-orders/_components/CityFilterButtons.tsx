        ...
        const ordersCount =
          city === "All cities"
            ...
            return(
                ...
                className={`p-2 w-auto h-10 rounded duration-300 cursor-pointer text-xs md:text-sm lg:text-base flex justify-between items-center gap-2 ${
              selectedCity === city
                ...
                >
                    {city}
                    <div className="text-white w-6 h-6 text-xs bg-primary rounded flex justify-center items-center">
                    {ordersCount}
                    </div>
                </button>
            )
