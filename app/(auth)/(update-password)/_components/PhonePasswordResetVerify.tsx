...
const PhonePasswordResetVerify = ({
  ...
  onBackAction,
    ...
    try {
      ...
      const response = await fetch("/api/auth/reset-phone-password", {
        method: "POST",
        headers: {
    ...
    <AuthFormLayout>
        <div className="flex flex-col gap-y-6">
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-2xl font-bold text-center">Enter the code from SMS</h1>
            </div>

            <p className="text-center">
                We send 4 digit code to <span className="text-primary font-medium">{phone}</span>
            </p>
            ...
            {error && error.includes("too many attemps") && (
                <button
