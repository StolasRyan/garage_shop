  ...
  return (
    <AuthFormLayout>
      <div className="flex flex-col gap-y-6">
        ...
        <div className="mt-4 p-4 bg-white rounded border border-primary">
          ...
          <p className="text-primary text-sm">
            ...
            <button
              ...
              className="text-primary font-medium underline hover:no-underline ml-1 cursor-pointer duration-300"
            >
