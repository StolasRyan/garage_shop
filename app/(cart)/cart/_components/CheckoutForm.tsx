import { DeliveryAdress as DeliveryAddressType, DeliveryTime as DeliveryTimeType } from "@/types/order";
...
const CheckoutForm = ({onFormDataChange}: CheckoutFormProps) => {
    ...
    useEffect(()=>{
        ...
        const isValid = isAdressValid && isTimeValid;
