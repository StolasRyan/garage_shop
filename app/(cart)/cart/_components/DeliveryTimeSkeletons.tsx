const DeliveryTimeSkeletons = () => {
  return (
    <div>
      <div className="h-8 lg:h-9 bg-gray-200 rounded mb-6 w-32 animate-pulse"></div>

      <div className="flex flex-col gap-y-4 md:flex-row md:flex-nowrap md:gap-x-8 lg:gap-x-10">
