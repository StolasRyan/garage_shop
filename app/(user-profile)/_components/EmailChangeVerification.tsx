...
const EmailChangeVerification = (props:EmailChangeVerification) => {
    const { username, currentEmail, newEmail, verifyUrl } = props;
  return (
          ...
          <Container className="bg-white rounded-md p-6 max-w-145 mx-auto">
            ...
            <Section className="mt-6 pt-4 border-t border-gray-200">
              ...
              <Text className="text-xs text-gray-400 m-0 text-center mt-2 leading-4">
                © {new Date().getFullYear()} GARAGE. Все права защищены.
              </Text>
            </Section>
          </Container>
        </Body>
