...
const NewProducts = async() => {
   ...
   let products: ProductCardProps[]=[];
       ...
       try{
           const res = await fetch(`${process.env.NEXT_PUBLICK_BASE_URL!}/api/products?category=new`);
    ...
    <section>
        <div className='flex flex-col justify-center xl:max-w-302'>
            <div className='mb-4 md:mb-8 xl:mb-10 flex flex-row justify-between'>
                <h2 className='text-2xl md:text-4xl text-left font-bold'>New</h2>
                <button className='flex flex-row items-center gap-x-2 cursor-pointer'>
                    <p className='text-base text-center text-gray-500 hover:text-gray-300'>All New</p>
