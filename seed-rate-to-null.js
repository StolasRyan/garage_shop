    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    client = new mongodb_1.MongoClient(process.env.GARAGE_SHOP_DB_URL);
                    return [4 /*yield*/, client.connect()];
                case 1:
                    _a.sent();
                    console.log('Соединение с MongoDB установлено');
                    db = client.db(process.env.GARAGE_SHOP_DB_NAME);
...
resetRateField();
// npx tsc seed-rate-to-null.ts // node seed-rate-to-null.js
